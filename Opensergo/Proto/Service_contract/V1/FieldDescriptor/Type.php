...
/**
 * Protobuf type <code>opensergo.proto.service_contract.v1.FieldDescriptor.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Opensergo\Proto\Service_contract\V1\FieldDescriptor_Type::class);
