 ...
 * in them.
 *
 * Generated from protobuf message <code>opensergo.proto.service_contract.v1.UninterpretedOption</code>
 */
class UninterpretedOption extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>repeated .opensergo.proto.service_contract.v1.UninterpretedOption.NamePart name = 2;</code>
     */
    private $name;
    /**
     ...
     *
     *     @type \Opensergo\Proto\Service_contract\V1\UninterpretedOption\NamePart[]|\Google\Protobuf\Internal\RepeatedField $name
    ...
    /**
     * Generated from protobuf field <code>repeated .opensergo.proto.service_contract.v1.UninterpretedOption.NamePart name = 2;</code>
     * @param \Opensergo\Proto\Service_contract\V1\UninterpretedOption\NamePart[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setName($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Opensergo\Proto\Service_contract\V1\UninterpretedOption\NamePart::class);
        $this->name = $arr;
